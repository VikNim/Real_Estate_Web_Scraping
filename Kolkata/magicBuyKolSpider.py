...
from ..items import MagicbuykolItem
...
class MagicbuykolspiderSpider(scrapy.Spider):
    name = "Magicbricks_SaleKolkata"
    allowed_domains = ["http://www.magicbricks.com/"]

    start_urls = [
        'http://www.magicbricks.com/property-for-sale/residential-real-estate?proptype=Multistorey-Apartment,Builder-Floor-Apartment,Penthouse,Studio-Apartment,Residential-House,Villa&cityName=Kolkata&sortBy=mostRecent/Page-1',
    ]
