...
class JustdialspiderSpider(scrapy.Spider):
    ...
    start_urls = [
        ...
        #  The Reason for to put another website in start_url is spider throws error 403 -Forbidden Request
        #  for justdial.com and spider is finished.This way we fool spider.
    ]
