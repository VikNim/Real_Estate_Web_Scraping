# -*- coding: utf-8 -*-
import scrapy
from ..items import MagicbricksPunerentItem
...
class MagicrentspiderhyderabadSpider(scrapy.Spider):
    name = "Magicbricks_RentPune"
    allowed_domains = ['magicbricks.com']
    start_urls = [
        'http://www.magicbricks.com/property-for-rent/residential-real-estate?proptype=Multistorey-Apartment,Builder-Floor-Apartment,Penthouse,Studio-Apartment,Service-Apartment,Residential-House,Villa&cityName=Pune&sortBy=mostRecent/Page-1',
    ]
