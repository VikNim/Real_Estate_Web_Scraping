...
import datetime
from ..items import MagicbricksPunebuyItem
from datetime import datetime as dt
import re
from scrapy.http import Request


class MagicsalepuneSpider(scrapy.Spider):
    name = "Magicbricks_SalePune"
    allowed_domains = ["magicbricks.com"]
    start_urls = [
        'http://www.magicbricks.com/property-for-sale/residential-real-estate?proptype=Multistorey-Apartment,Builder-Floor-Apartment,Penthouse,Studio-Apartment,Residential-House,Villa&cityName=Pune&sortBy=mostRecent/Page-1',
    ]
    custom_settings = {
        'DEPTH_LIMIT': 10000,
        'DOWNLOAD_DELAY': 5.0,
