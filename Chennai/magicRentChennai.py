...
from ..items import MagicbricksrentchennaiItem
...
class MagicrentchennaiSpider(scrapy.Spider):
    name = "Magicbricks_RentChennai"
    allowed_domains = ["magicbricks.com"]
    start_urls = [
        'http://www.magicbricks.com/property-for-rent/residential-real-estate?proptype=Multistorey-Apartment,Builder-Floor-Apartment,Penthouse,Studio-Apartment,Service-Apartment,Residential-House,Villa&cityName=Chennai&sortBy=mostRecent/Page-1',
    ]
    custom_settings = {
        'DEPTH_LIMIT': 10000,
        'DOWNLOAD_DELAY': 5.0,
    ...
    def parse(self, response):
        ...
        try:
            ...
            k = 0
            item = MagicbricksrentchennaiItem()
            for i in data:
                try:
                    item['address'] = 'None'
                    item['areacode'] = 'None'
        ...
        if pagecount == 0 or pagecount is None:
            if 'resultBlockWrapper' in str(response.body):
                ...
                # 'http://www.magicbricks.com/property-for-rent/residential-real-estate?proptype=Multistorey-Apartment,Builder-Floor-Apartment,Penthouse,Studio-Apartment,Service-Apartment,Residential-House,Villa&cityName=Bangalore&sortBy=mostRecent/Page-1' + str(pageNo + 1)
                # print(url)
