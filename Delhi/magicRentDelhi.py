# -*- coding: utf-8 -*-
import scrapy
from ..items import MagicrentdelItem
...
class MagicrentdelhiSpider(scrapy.Spider):
    name = "Magicbricks_RentDelhi"
    allowed_domains = ['magicbricks.com']
    start_urls = [
        'http://www.magicbricks.com/property-for-rent/residential-real-estate?proptype=Multistorey-Apartment,Builder-Floor-Apartment,Penthouse,Studio-Apartment,Service-Apartment,Residential-House,Villa&cityName=Delhi-NCR&sortBy=mostRecent/Page-1',
    ]
